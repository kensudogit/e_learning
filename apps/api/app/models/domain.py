...
class User(Base):
    ...
    login_id: Mapped[str | None] = mapped_column(String(255), unique=True, nullable=True, index=True)
    is_contractor: Mapped[bool] = mapped_column(Boolean, default=False)  # 契約者（受講者と分離可能）
